...
4. Importe o banco de dados
    ...
    4.2 Crie um banco chamado sistemachacara
    4.3 Clique em importar
    4.4 Selecione o arquivo .sql incluído no projeto

5. Abra no navegador localhost/sistemachacara
